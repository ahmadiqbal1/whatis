            ...
            <table>
                ...
                @foreach($order_products->products as $k=>$product)
                    <tr class="service">
                        @if($product->variant_id != 0)
                            ...
                            <td class="tableitem"><p class="itemtext"> {{App\Utility::priceFormat($product->variant_price*$product->quantity+$total_tax)}}</p></td>
                        @else
                            ...
                            <td class="tableitem" style="text-align: center"><p class="itemtext">{{$product->quantity}}</p></td>
                            <td class="tableitem"><p class="itemtext"> {{App\Utility::priceFormat($product->price*$product->quantity+$total_tax)}}</p></td>
                        @endif
                    </tr>
                @endforeach
                @if(!empty($shipping_data) && $discount_value != 0)
                    <tr class="tabletitle">
                        ...
                        <td class="payment"><h2>{{App\Utility::priceFormat($discount_value)}}</h2></td>
                    </tr>
                    <tr class="tabletitle">
                        <td></td>
                        <td class="Rate"><h2>{{__('Shipping Price')}} :</h2></td>
                        <td class="payment"><h2>{{App\Utility::priceFormat($shipping_data->shipping_price)}}</h2></td>
                    </tr>
                    <tr class="tabletitle">
                        <td></td>
                        <td class="Rate"><h2>{{__('Grand Total')}}</h2></td>
                        <td class="payment"><h2>{{App\Utility::priceFormat(($sub_total+$total_taxs+$shipping_data->shipping_price)-$discount_value)}}</h2></td>
                    </tr>
                @elseif(!empty($shipping_data))
                    ...
                    <tr class="tabletitle">
                        <td></td>
                        <td class="Rate"><h2>{{__('Grand Total')}}</h2></td>
                        <td class="payment"><h2>{{App\Utility::priceFormat($sub_total+$total_taxs+$shipping_data->shipping_price)}}</h2></td>
                    </tr>
                @elseif($discount_value != 0)
                    ...
                    <tr class="tabletitle">
                        <td></td>
                        <td class="Rate"><h2>{{__('Grand Total')}}</h2></td>
                        <td class="payment"><h2>{{App\Utility::priceFormat(($sub_total+$total_taxs)-$discount_value)}}</h2></td>
                    </tr>
                @else
                    <tr class="tabletitle">
                        <td></td>
                        <td class="Rate"><h2>{{__('Grand Total')}}</h2></td>
                        <td class="payment"><h2>{{App\Utility::priceFormat($sub_total+$total_taxs)}}</h2></td>
                    </tr>
                @endif
            </table>
        </div>
