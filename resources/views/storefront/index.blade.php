        ...
        <nav class="navbar header-navbar navbar-expand floating-nav align-items-center">
            <div class="navbar-container d-flex align-items-center">
                <a href="#" class="nav-brand nav-logo">
                    <img src="{{asset(Storage::url('uploads/store_logo/').(!empty($store->logo)?$store->logo:'logo.png'))}}" class="header_img" width="200px" style="margin:15px 9px;">
                </a>
                        ...
                        <div class="card delivery-card">
                            ...
                            <div class="card-body detail-form">
                                ...
                                <div class="form-group">
                                    ...
                                    {{Form::text('phone',old('phone'),array('class'=>'active input-mask phone',"data-mask"=>"+00 00000000000",'required'=>'required'))}}
                                </div>
                                <div class="form-group">
