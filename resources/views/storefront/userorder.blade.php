                                    ...
                                    <div class="table-responsive">
                                        <table class="table mb-0">
                                            ...
                                            <tr>
                                                ...
                                                <td>{{App\Utility::priceFormat($final_taxs)}}</td>
                                            </tr>
                                            ...
                                            @if(!empty($shipping_data))
                                                @if(!empty($discount_value))
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th>{{ App\Utility::priceFormat($grand_total+$shipping_data->shipping_price-$discount_value) }}</th>
                                                    </tr>
                                                @else
                                                    <tr>
                                                        <td>{{__('Shipping Price')}} :</td>
                                                    ...
                                                    <tr>
                                                        <th>{{__('Grand Total')}} :</th>
                                                        <th>{{ App\Utility::priceFormat($grand_total+$shipping_data->shipping_price) }}</th>
                                                    </tr>
                                                @endif
                                            @elseif(!empty($discount_value))
                                                <tr>
                                                    <th>{{__('Grand  Total')}} :</th>
                                                    <th>{{ App\Utility::priceFormat($grand_total-$discount_value) }}</th>
                                                </tr>
                                            @else
                                                <tr>
                                                    <th>{{__('Grand  Total')}} :</th>
                                                    <th>{{ App\Utility::priceFormat($grand_total) }}</th>
                                                </tr>
                                            @endif
